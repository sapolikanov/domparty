...
var_label(data_built) <- list(
  ...
  col.type = "Colonial Legacy",
  v2xps_party_mean = "PSI (Mean)",
  v2xos_party_next = "PSI (Next Year Imputed)",
  ...
  enpp = "ENPP",
  enep = "ENEP",
  e_peaveduc_mean = "Education (Mean)",
  e_peaveduc_next = "Education (Next Year Imputed)",
  oil_rent_perc_gdp = "Oil Rents (%)",
  oil_rent_dummy = "Oil Dummy"
)

missing_pairs(data_built, dependent = "partyreg", 
              explanatory = c("housesys", "elf_fill", "v2xps_party_mean", 
                              "col.type", "enpp", "v2x_polyarchy",
